...
I (the instructor) will take on **Role 1**, and will choose someone to take on **Role 2** for this demonstration. 
...
-   Add a code chunk on around line 55. Type some code
-   Render, commit, push. You should get an error.
...
-   Add a code chunk around line 55. Also type some code.
-   Render, commit, push. You should get an error.
